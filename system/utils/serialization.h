...
//------------add for frequent pattern mining project-------
obinstream& operator<<(obinstream& m, short i)
{
...
//new function added by Torby
template <class KeyT, class ValT>
obinstream& operator<<(obinstream& m, const unordered_map<KeyT, ValT>& v)
{
    m << v.size();
...
//new function added by Torby
template <class T>
obinstream& operator<<(obinstream& m, const unordered_set<T>& v)
{
    m << v.size();
...
//---------------add for frequent mining project--------
ibinstream& operator>>(ibinstream& m, short& i)
{
...
//new function added by Torby
template <class KeyT, class ValT>
ibinstream& operator>>(ibinstream& m, unordered_map<KeyT, ValT>& v)
{
    size_t size;
    m >> size;
    for (int i = 0; i < size; i++) {
...
template <class T>
ibinstream& operator>>(ibinstream& m, unordered_set<T>& v)
{
    size_t size;
    m >> size;
    for (int i = 0; i < size; i++) {
